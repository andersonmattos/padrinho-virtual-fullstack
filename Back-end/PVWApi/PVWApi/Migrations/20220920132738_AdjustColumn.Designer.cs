...
namespace PVWApi.Migrations
{
    ...
    [Migration("20220920132738_AdjustColumn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CasamentoConvidado", b =>
                {
                    ...
                    b.HasKey("CasamentoId", "ConvidadoId");

                    b.HasIndex("ConvidadoId");

                    b.ToTable("CasamentoConvidado");
                });
            ...
            modelBuilder.Entity("CasamentoConvidado", b =>
                {
                    b.HasOne("PVWApi.Models.Casamento", null)
                        .WithMany()
                        .HasForeignKey("CasamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVWApi.Models.Convidado", null)
                        .WithMany()
